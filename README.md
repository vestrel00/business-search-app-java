...
2. THE ANDROID APPLICATION *presentation-android-mvp* CAN BE RUN BUT IS NOT YET FEATURE COMPLETE.
3. THIS PROJECT IS UNDER HEAVY DEVELOPMENT. BY NO MEANS IS IT CLOSE TO DONE.   
4. THIS REPOSITORY WILL REMAIN PRIVATE UNTIL IT HAS BEEN COMPLETED.  
5. COMMITS HAVE BEEN PUSHED DIRECTLY INTO THE DEVELOP BRANCH INSTEAD OF THROUGH PULL REQUESTS.  
6. DEVELOP BRANCH COMMIT HISTORY IS EXTREMELY DIRTY.  
7. ONCE COMPLETED, ALL CODE WILL BE RE-DONE PROPERLY WITH FEATURE BRANCHES, ISSUES, AND PULL REQUESTS.
8. AT THAT POINT ALL WORK WILL BE LOGGED IN DOCS/DEV_LOGS.MD AND MERGED THROUGH WELL-DOCUMENTED 
