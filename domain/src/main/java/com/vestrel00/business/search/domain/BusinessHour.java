 ...
 */
@AutoValue
public abstract class BusinessHour implements DomainObject {

    /**
     * @return a new {@link Builder}
     */
    public static Builder builder() {
        return new AutoValue_BusinessHour.Builder();
    }
    ...
    /**
     * Builder used to create instances of {@link BusinessHour}.
     */
    @AutoValue.Builder
    public abstract static class Builder {
        ...
        public abstract BusinessHour build();
    }
}
